...
//             return;
//         }
//  const filteredButtons = mainMenuButtons.filter(({ key }: IToolboxNativeButton) => key !== 'chat');
...
function Toolbox(props: IProps) {
    ...
    // Solid color background for bottom bar
    style.backgroundColor = '#075e54'; // WhatsApp's dark green color
 ...
 const filteredButtons = mainMenuButtons.filter(({ key }: IToolboxNativeButton) => key !== 'chat' && key !== 'overflowmenu' && key !== 'invite');
